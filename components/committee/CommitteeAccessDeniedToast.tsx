...
/**
 * Inline "Access Denied" toast rendered on the Committee Review route when the
 * connected wallet is not a committee member. Shown briefly over the skeleton
 * before the page redirects to `/`, matching the unauthorized-state design.
 */
export default function CommitteeAccessDeniedToast() {
  return (
    <div
      role="alert"
