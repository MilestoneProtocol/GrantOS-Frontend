  ...
  return (
    <div className="guidelines-page mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 xl:py-12">
      <header className="mb-8 max-w-3xl space-y-3 xl:mb-10">
        <span className="inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-blue-800 dark:border-blue-900/50 dark:bg-blue-950/40 dark:text-blue-200">
          Protocol Reference
        </span>
        <h1 className="text-[26px] font-bold tracking-tight text-slate-900 dark:text-slate-100 sm:text-[32px] xl:text-[48px] xl:leading-tight">
      ...
      <div className="sticky top-[57px] z-20 -mx-4 border-b border-slate-200/80 bg-white/90 px-4 py-3 backdrop-blur supports-backdrop-filter:bg-white/80 dark:border-slate-800 dark:bg-slate-950/90 md:-mx-6 md:px-6 xl:static xl:z-auto xl:mx-0 xl:border-0 xl:bg-transparent xl:p-0 xl:backdrop-blur-none">
